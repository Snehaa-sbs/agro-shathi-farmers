...
const translations: Record<string, Record<Language, string>> = {
  ...
  'auth.signupSubtitle': { en: 'Join AgroSmart to grow smarter', bn: 'স্মার্ট চাষের জন্য যোগ দিন' },
  'auth.welcomeBack': { en: 'Welcome Back', bn: 'স্বাগতম' },
  'auth.signinSubtitle': { en: 'Sign in to your farming account', bn: 'আপনার কৃষি অ্যাকাউন্টে সাইন ইন করুন' },
  'auth.fullName': { en: 'Full Name', bn: 'পুরো নাম' },
  'auth.fullNamePlaceholder': { en: 'Enter your name', bn: 'আপনার নাম লিখুন' },
  ...
  'auth.googleSignIn': { en: 'Continue with Google', bn: 'গুগল দিয়ে চালিয়ে যান' },
  'auth.orContinueWith': { en: 'or continue with', bn: 'অথবা' },
  'auth.hasAccount': { en: 'Already have an account?', bn: 'আগে থেকে অ্যাকাউন্ট আছে?' },
  'auth.noAccount': { en: "Don't have an account?", bn: 'অ্যাকাউন্ট নেই?' },
  'auth.forgotPassword': { en: 'Forgot Password?', bn: 'পাসওয়ার্ড ভুলে গেছেন?' },
  'auth.forgotSubtitle': { en: 'Enter your email to reset password', bn: 'পাসওয়ার্ড রিসেট করতে ইমেইল দিন' },
  'auth.sendResetLink': { en: 'Send Reset Link', bn: 'রিসেট লিংক পাঠান' },
  'auth.resetEmailSent': { en: 'Reset link sent to your email', bn: 'রিসেট লিংক ইমেইলে পাঠানো হয়েছে' },
  'auth.checkEmail': { en: 'Check your email for the reset link', bn: 'রিসেট লিংকের জন্য ইমেইল দেখুন' },
  'auth.backToSignIn': { en: 'Back to Sign In', bn: 'সাইন ইন-এ ফিরুন' },
  'auth.resetPassword': { en: 'Reset Password', bn: 'পাসওয়ার্ড রিসেট' },
  'auth.newPassword': { en: 'New Password', bn: 'নতুন পাসওয়ার্ড' },
  'auth.passwordUpdated': { en: 'Password updated successfully', bn: 'পাসওয়ার্ড সফলভাবে আপডেট হয়েছে' },
  'auth.signupSuccess': { en: 'Account created! Please verify your email.', bn: 'অ্যাকাউন্ট তৈরি হয়েছে! ইমেইল ভেরিফাই করুন।' },
  'auth.loginSuccess': { en: 'Welcome back!', bn: 'স্বাগতম!' },
